...
[Running Spark on Mesos](running-on-mesos.html). However, if you just want to run Spark on a single machine (possibly using multiple cores),
...
* [Running Spark on YARN](running-on-yarn.html): instructions on how to run Spark on top of a YARN cluster
* [Spark Standalone Mode](spark-standalone.html): instructions on running Spark without Mesos
...
If you'd like to contribute code to Spark, read [how to contribute](contributing-to-spark.html).
